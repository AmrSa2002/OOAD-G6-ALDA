...
namespace FlyAway.Controllers
{
    public class KartaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PutnikId,LetId,BrojKreditneKartice,NacinPlacanja")] Karta karta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PutnikId,LetId,BrojKreditneKartice,NacinPlacanja")] Karta karta)
        {
            if (id != karta.Id)
            {
                return NotFound();
