...
namespace FlyAway.Controllers
{
    public class RecenzijaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,LetId,Text,Rating,CommentDate")] Recenzija recenzija)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,LetId,Text,Rating,CommentDate")] Recenzija recenzija)
        {
            if (id != recenzija.Id)
            {
                return NotFound();
