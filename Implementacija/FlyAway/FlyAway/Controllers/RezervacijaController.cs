...
namespace FlyAway.Controllers
{
    public class RezervacijaController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Rezervacija.Include(r => r.Let).Include(r => r.Putnik);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdPutnika"] = new SelectList(_context.Putnik, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,IdPutnika,IdLeta")] Rezervacija rezervacija)
        {
            ...
            ViewData["IdPutnika"] = new SelectList(_context.Putnik, "Id", "Id", rezervacija.IdPutnika);
            return View(rezervacija);
        }
