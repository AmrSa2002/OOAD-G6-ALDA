...
namespace FlyAway.Controllers
{
    ...
    public class DestinacijaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Naziv")] Destinacija destinacija)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naziv")] Destinacija destinacija)
        {
